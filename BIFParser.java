...
/* Line 448 of "BIFParser.y"  */
    { yyval = Double.valueOf(((Integer)(yystack.valueAt (1-(1)))).intValue()); };
  break;
...
/* Line 623 of "BIFParser.java"  */
  ...
  /* YYR1[YYN] -- PropositionSymbol number of symbol that rule YYN derives.  */
  private static final byte
  yyr1_[] =
  {
  ...
  protected void defineProbabilityTableEntry(CPT cpt, Value value, Assignment a, List<RandomVariable> givens, Iterator<Double> ptvalues) {
	  if (givens.isEmpty()) {
		  ...
		  for (Value v : firstGiven.getRange()) {
			  //trace("defineProbabilityTableEntry: " + firstGiven + "=" + variable);
			  a.put(firstGiven, v);
